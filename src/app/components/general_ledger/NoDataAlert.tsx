// ============================================================
// NoDataAlert.tsx — pop-up shown when export is triggered with no data
// ============================================================
...
export default function NoDataAlert({ isOpen, onClose }: NoDataAlertProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
            ...
            <div className="w-full max-w-sm bg-[#0f1117] border border-amber-500/20
              ...
              <div className="px-6 py-7 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-400 leading-relaxed mb-6">
                  لا توجد حركات مالية في الفترة المحددة للحساب المختار.
                  <br />
