// ============================================================
// DeleteConfirmModal.tsx — Confirmation before deleting a supplier
// ============================================================
import { AlertTriangle, X } from "lucide-react";
import { motion, AnimatePresence } from "motion/react";
import { tPro }  from "../../core/i18n/procurement.i18n";
import type { DeleteConfirmModalProps } from "../../core/models/procurement.types";
        ...
        <div className="w-full max-w-sm bg-gradient-to-b from-[#0F172A] to-[#1A2236]
          ...
          <div className="flex items-center justify-between p-5 border-b border-white/10">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-bold text-white">{tPro(lang, "deleteTitle")}</h2>
            </div>
