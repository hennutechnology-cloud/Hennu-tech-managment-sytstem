...
import { Eye, CreditCard, FileDown, TrendingUp, TrendingDown, FileText } from "lucide-react";
import GlassCard from "../../core/shared/components/GlassCard";
import { tInv, formatCurrency, formatDate, STATUS_STYLES, ACCOUNT_STYLES } from "../../core/i18n/invoice.i18n";
...
function InvoiceCard({ invoice, lang, onDetails, onAddPayment, onExportPdf }: {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl bg-white/[0.04] border border-white/10 p-4 space-y-3"
      dir={isRtl ? "rtl" : "ltr"}
    >
      {/* Header */}
      <div className={`flex items-start justify-between gap-2 ${isRtl ? "flex-row-reverse" : ""}`}>
        <div>
          ...
          <p className="text-xs text-gray-400 mt-0.5">{invoice.partyName}</p>
        </div>
