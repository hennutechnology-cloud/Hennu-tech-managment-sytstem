// ============================================================
// ContractDeleteConfirm.tsx — Responsive
// ============================================================
import { useState }                from "react";
import { motion, AnimatePresence } from "motion/react";
import { AlertTriangle, X }        from "lucide-react";
import { tContract, dirAttr, flip } from "../../core/i18n/contracts.i18n";
import type { ContractDeleteConfirmProps } from "../../core/models/contracts.types";

export default function ContractDeleteConfirm({
  isOpen, contract, lang, onConfirm, onCancel,
}: ContractDeleteConfirmProps) {
  ...
  const inner = (
    <div dir={dirAttr(lang)}>
      ...
      <h3 className="text-base sm:text-lg font-bold text-white mb-2">
        {tContract(lang, "deleteTitle")}
      </h3>
      <p className="text-gray-300 text-sm mb-1">
        {tContract(lang, "deleteQuestion")}{" "}
        <span className="text-white font-semibold">"{contract.contractNumber}"</span>?
      </p>
      <p className="text-red-400/80 text-xs mb-5 sm:mb-6">
        {tContract(lang, "deleteWarning")}
      </p>
